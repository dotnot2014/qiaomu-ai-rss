...
const options = { entryPoints: ['src/main.ts'], bundle: true, loader: { '.woff2': 'dataurl' }, external: ['obsidian', '@codemirror/view', '@codemirror/state', 'electron', 'node:fs', 'node:path'], format: 'cjs', target: 'es2022', outfile: 'main.js', logLevel: 'info', sourcemap: false, minify: true, keepNames: true, banner: { js: `/*! Qiaomu RSS — Copyright (c) 2026 向阳乔木; GPL-3.0-only.\nSource: https://github.com/joeseesun/qiaomu-ai-rss\n${projectLicense}\nBlog catalog: https://github.com/timqian/chinese-independent-blogs\n${catalogLicense}\nBundled fonts: SIL OFL 1.1\n${fontLicense}\nTurndown: MIT\n${turndownLicense}\nTurndown GFM: MIT\n${turndownGfmLicense}*/` } };
